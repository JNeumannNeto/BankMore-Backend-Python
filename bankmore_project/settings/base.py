...
ROOT_URLCONF = 'bankmore_project.urls'
...
WSGI_APPLICATION = 'bankmore_project.wsgi.application'

DATABASES = {
    'default': dj_database_url.config(
        default=f'sqlite:///{BASE_DIR}/database/bankmore.db',
        conn_max_age=600,
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'BankMore API',
    'DESCRIPTION': 'Sistema Bancário com Microserviços',
    'VERSION': '1.0.0',
...
FEE_SETTINGS = {
    'TRANSFER_FEE_AMOUNT': config('TRANSFER_FEE_AMOUNT', default=2.00, cast=float),
}
